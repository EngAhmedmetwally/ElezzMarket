    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Card>
            ...
            <CardContent>
                <div className="text-3xl font-bold">{formatCurrency(totalCancelledValue, language)}</div>
            </CardContent>
        </Card>
      </div>
       ...
       <Card>
        <CardHeader>
          <CardTitle>{language === 'ar' ? 'الطلبات الملغاة حسب الوسيط' : 'Cancellations by Moderator'}</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <TableBody>
              {cancelledOrdersInfo.map((order) => (
                <TableRow key={order.orderId}>
                  ...
                  <TableCell className="text-end">{formatCurrency(order.orderTotal, language)}</TableCell>
                </TableRow>
              ))}
