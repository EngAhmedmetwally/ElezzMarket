...
const statusColors: Record<string, string> = {
  ...
  "قيد الانتظار": "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/70 dark:text-yellow-300 border-yellow-300/50 dark:border-yellow-700/80",
  "Confirmed": "bg-blue-100 text-blue-800 dark:bg-blue-900/70 dark:text-blue-300 border-blue-300/50 dark:border-blue-700/80",
  "مؤكد": "bg-blue-100 text-blue-800 dark:bg-blue-900/70 dark:text-blue-300 border-blue-300/50 dark:border-blue-700/80",
  ...
  "قيد المعالجة": "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/70 dark:text-indigo-300 border-indigo-300/50 dark:border-indigo-700/80",
  ...
  "تم الشحن": "bg-purple-100 text-purple-800 dark:bg-purple-900/70 dark:text-purple-300 border-purple-300/50 dark:border-purple-700/80",
  ...
  "تم التوصيل": "bg-green-100 text-green-800 dark:bg-green-900/70 dark:text-green-300 border-green-300/50 dark:border-green-700/80",
